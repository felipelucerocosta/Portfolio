...
const neonColors = ["#b15eff", "#00f7ff", "#7000ff", "#ff007f", "#00bfff", "#00ffcc", "#8b5cf6", "#d946ef", "#06b6d4"];
...
const education = [
    ...
    },
    {
        ...
        org: "Generación T",
        desc: "Formación en tecnologías Frontend y Backend, desarrollo de aplicaciones web dinámicas con bases de datos relacionales. Ampliación del stack técnico como complemento a la especialidad Frontend."
    },
    {
...
const skillsData = {
    ...
    backend: [
        { name: "NodeJS", icon: "fab fa-node-js", level: "Básico / Integración" },
        { name: "PostgreSQL", icon: "devicon-postgresql-plain", level: "Básico / Integración" },
